...
namespace DemoQLDA.Controllers.api
{
    ...
    public class ClaimSetupController : ControllerBase
    {
        ...
        public ClaimSetupController(UserManager<User> userManager, IConfiguration configuration, ApplicationDbContext dbContext, RoleManager<IdentityRole> roleManager, ILogger<AuthManagermentController> logger)
        {
            _logger = logger;
