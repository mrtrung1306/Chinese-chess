...
namespace DemoQLDA.Controllers.api
{
    ...
    public class SetupController : ControllerBase
    {
        ...
        public SetupController(ApplicationDbContext context, UserManager<User> userManager, RoleManager<IdentityRole> roleManager, ILogger<SetupController> logger, UserService userService)
        {
            _context = context;
